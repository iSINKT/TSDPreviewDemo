...
namespace TSD.PreviewDemo.App.ViewDialogs
{
    ...
    public class YesNoQuestionDialog : Dialog
    {
        public YesNoQuestionDialog(Context context) : base(context)
        {
            _message = Context.GetString(Resource.String.dialog_tv_message);
        }
        public YesNoQuestionDialog(Context context, string message) : base(context)
        {
            _message = message;
        }
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.dialog_yes_no_question_dialog);
